...
public class CollectAllFragment extends MvpBaseFragment<CollectContract.ICollectPresenter> implements CollectContract.ICollectView, View.OnClickListener {
    private static final String TAG = "CollectAllFragment";

...
public class NestedScrollingDetailContainer extends ViewGroup implements NestedScrollingParent2 {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        Log.d("Test1", " ---------  onTouchEvent ------- " + event.getAction());
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action & MotionEvent.ACTION_MASK) {
            case MotionEvent.ACTION_MOVE:
                ...
                if (yDiff > TOUCH_SLOP  && !isInNestedChildViewArea) {
                  ...
                  /*  if (parent != null) {
                        if(Math.abs(ev.getX() - lastX) > mLastMotionY){
        ...
        Log.d("Test1", " ---------  onInterceptTouchEvent ------- " + ev.getAction() + " _ " + mIsBeingDragged);
